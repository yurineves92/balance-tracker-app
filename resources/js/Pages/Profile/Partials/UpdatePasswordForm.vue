...
<template>
    <section>
        <header>
            ...
            <p class="mt-1 text-sm text-gray-600">Certifique-se de que sua conta está usando uma senha longa e aleatória para manter a segurança.</p>
        </header>
        ...
        <form @submit.prevent="updatePassword" class="mt-6 space-y-6">
            ...
            <div>
                <InputLabel for="password_confirmation" value="Confirmar a Nova Senha" />
